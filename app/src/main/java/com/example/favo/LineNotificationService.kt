...
class LineNotificationService : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        for (entry in targets) {
            ...
            sendFavoNotification(sns, name, soundType)
            playSound(soundType)
    ...
    // Favo通知
    // ===============================
    private fun sendFavoNotification(sns: String, name: String, soundType: String) {
        ...
        // custom_notification.xml の TextView と ImageView に値を設定
        ...
        val smallIconRes = if (soundType == "oshi") R.drawable.ic_notify_star else R.drawable.ic_notify_heart

        val notification = NotificationCompat.Builder(this, channelId)
            .setSmallIcon(smallIconRes)
            .setStyle(NotificationCompat.DecoratedCustomViewStyle()) // カスタムビュースタイル
            .setCustomContentView(remoteViews) // カスタムビューをセット
